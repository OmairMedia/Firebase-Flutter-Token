...
class TransitFindingBestRatesCard extends StatefulWidget {
   // ignore: use_key_in_widget_constructors
  final String status;

  const TransitFindingBestRatesCard({
    Key? key, 
  ...
  @override
  _TransitFindingBestRatesCardState createState() => _TransitFindingBestRatesCardState();
}

class _TransitFindingBestRatesCardState extends State<TransitFindingBestRatesCard> {
  @override
