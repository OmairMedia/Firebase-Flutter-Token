...
class OfferRejectedCard extends StatefulWidget {
  ...
  @override
  _OfferRejectedCardState createState() => _OfferRejectedCardState();
}

class _OfferRejectedCardState extends State<OfferRejectedCard> {
  @override
